  ...
  <svg
    ...
    <defs>
      ...
      <filter
        ...
        filterUnits="objectBoundingBox"
        id="filter-4">
        <feOffset dx="0" dy="-1" result="shadowOffsetInner1" />
        <feComposite
          in2="SourceAlpha"
          operator="arithmetic"
          k2="-1"
    ...
    <g id="Landing" stroke="none" fill="none">
      <g id="Artboard" transform="translate(-194.000000, -228.000000)">
        <g id="Group" transform="translate(183.000000, 186.000000)">
          <g
            ...
            <g id="search" transform="translate(0.000000, 2.000000)">
              <g id="bg">
                <use fill="#FFFFFF" />
                <use fill="black" filter="url(#filter-4)" />
              </g>
              <g
